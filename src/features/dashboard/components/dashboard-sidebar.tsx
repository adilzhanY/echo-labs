...
export function DashboardSidebar() {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:adilzhan1112@gmail.com",
      icon: Headphones,
    },
  ];
      ...
      <SidebarHeader className="flex flex-col gap-4 pt-4">
        ...
        <SidebarMenuItem>
          <OrganizationSwitcher
            hidePersonal
            fallback={
              <Skeleton className="h-8.5 w-full group-data-[collapsible=icon]:size-8 rounded-md bg-white" />
            }
            appearance={{
              elements: {
                rootBox:
                ...
                organizationSwitcherTrigger:
                  "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap-3! group-data-[collapible=icon]:w-auto! group-data-[collapsible=icon]:p-1!",
                organizationPreview: "gap-2!",
                organizationPreviewAvatarBox: "size-6! rounded-sm!",
                organizationPreviewTextContainer:
                  "text-xs! tracking-tight! font-medium! text-freground! group-data-[collapsible=icon]:hidden!",
